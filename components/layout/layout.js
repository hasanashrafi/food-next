...
function Layout({ children }) {
    return (
        <>
            <header className='flex flex-wrap  w-screen  h-fit place-items-center bg-[#004225] justify-between'>
                <div className=' text-2xl w-1/4 sm:w-fit font-semibold text-[#F5F5DC]  m-2'>
                ...
                <div className='flex flex-wrap justify-around  text-[#F5F5DC]  w-1/10 sm:w-48 md:w-48 xl:w-48 text-sm sm:font-semibold   m-2'>
