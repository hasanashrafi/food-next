...
function Attributes() {
    return (
        <div className='w-full h-fit mt-24 p-3 sm:text-xl'>
            <h3 className="text-lg sm:text-2xl text-[#53c60b] my-6">Why us?</h3>

            <div className='w-full flex flex-wrap justify-center sm:justify-between text-center place-items-center '>
